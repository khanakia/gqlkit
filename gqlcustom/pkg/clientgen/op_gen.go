...
// ArgumentData describes a single argument on an operation builder method.
...
// OperationBuilderData is the template data for a query/mutation builder.
...
// graphQLOpToGoType converts a GraphQL type to the Go type used in builders.
// Objects and interfaces live in the types package, input objects in inputs.
...
// formatGraphQLType formats a GraphQL type string for SetArg (e.g., "[AiModelOrder!]", "Int!").
...
func (g *Generator) generateOperationFilesForType(opType string, def *ast.Definition) error {
	...
	for _, field := range def.Fields {
		...
		// Root package for generated SDK (e.g., gqlcustom/sdk).
		...
		file.WriteString("// Code generated by gqlcustom. DO NOT EDIT.\n\n")
...
// generateQueryRootFile generates the queries/root.go entrypoint.
func (g *Generator) generateQueryRootFile() error {
	...
	sb.WriteString("// Code generated by gqlcustom. DO NOT EDIT.\n\n")
	sb.WriteString("package queries\n\n")
	if rootPkg != "" {
		fmt.Fprintf(&sb, "import %q\n\n", rootPkg+"/builder")
	} else {
		sb.WriteString("import \"gqlcustom/sdk/builder\"\n\n")
	}
...
// generateMutationRootFile generates the mutations/root.go entrypoint.
